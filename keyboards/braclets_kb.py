...
def create_filter_keyboard_braclets(user_filters):
    ...
    keyboard.add(
        InlineKeyboardButton(f"{price_text}", callback_data="filter_price_braclets"),
        InlineKeyboardButton(f"{brand_text}", callback_data="filter_brand_braclets"),
        InlineKeyboardButton(f"{condition_text}", callback_data="filter_condition_braclets"),
        InlineKeyboardButton(f"{gender_text}", callback_data="filter_gender_braclets")
    )

    # Кнопка "Сбросить фильтры"
    reset_button = InlineKeyboardButton("Сбросить фильтры", callback_data="reset_filters_braclets")
    keyboard.add(reset_button)

    keyboard.add(InlineKeyboardButton("Поиск🔎", switch_inline_query_current_chat="braclets"))
